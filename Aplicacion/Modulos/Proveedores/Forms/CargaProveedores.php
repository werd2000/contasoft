...
class Form_CargaProveedores extends Zend_Form
{
...
//        array(array('data' => 'HtmlTag'), array('tag' => 'div', 'class' => 'element-group')),
    ...
    public function mostrar()
    {
        ...
        if ($valorId==0){
            $this->setAction('index.php?option=proveedores&sub=agregar');
        }else{
            $this->setAction('index.php?option=proveedores&sub=editar&id='.$valorId);
        }
        $this->setMethod("POST");
        $this->setAttrib('id', 'frmproveedores');
        /** Id  **/
